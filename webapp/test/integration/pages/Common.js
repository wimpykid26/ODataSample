sap.ui.define([
	...
	return Opa5.extend("Northwind.ProductsData.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["Northwind/ProductsData/localService/mockserver"], function (mockserver) {
